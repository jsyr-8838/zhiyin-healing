...
export default function Error({
  ...
  useEffect(() => {
    console.error('色彩诊断 module error:', error.digest ?? error.message);
  }, [error]);

  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-50 to-rose-50 px-4">
      <div className="glass-card p-8 text-center max-w-sm">
        ...
        <h2 className="text-lg font-bold font-serif text-gray-800 mb-2">色彩诊断模块加载异常</h2>
