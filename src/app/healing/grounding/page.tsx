...
请您记住这个味道——它是今天疗愈的开始。`,
    closingScript: `好，闻灸就到这里。接下来，我们进入第二步——热敷药包，排出体表的寒湿。`,
    tips: [
      '引导客人靠近灸条轻嗅，感受药香',
      '展示防伪标识增强信任',
...
我会沿着您的脊柱、膀胱经和肩颈方向推拿，大约五分钟。
脊柱是督脉，阳气之海，我会由下往上推；
膀胱经是人体最大的代谢通道，先推左侧行气，再推右侧行血，气推血行。
请您配合呼吸，当我推的时候，慢慢呼气，让身体更松一些。`,
...
我会沿肩胛骨缝做横向的摇拨动作，力度由浅入深，一点一点地，把粘连的地方剥开。
...
定三到五分钟，期间请盖好被子，别着凉。
拔完之后，我会根据您的罐印和出痧的颜色，辨识您的体质，对症搭配穴位。`,
...
定钟就到这里，接下来，进入今天最核心的——病理火灸。`,
  ...
  },
  {
    ...
    openingScript: `姐，接下来我帮您点燃药灸。
这是今天最核心的环节——病理火灸。
我现在开始给您放灸了。在这个过程中，您千万不要动。
如果出现烫、痒或者水珠的现象，您一定要马上告诉我，我可以快速帮您调整。
不是越烫越好，有任何不舒服的症状及时跟我说，我会一直在您身边陪伴您。
现在，请闭上眼睛，让灸火温暖您的经脉。
这是属于您的静养时间——什么都不用做，只是躺着，感受灸的能量。`,
    midwayScript: `灸火正在温通您的经脉。
您可能会感觉到热力从皮肤表面慢慢渗透到深层，那是药力正在到达需要它的地方。
如果感到温暖而舒适，就让它继续。
如果感到灼烫，不要忍——告诉我，我马上调整。
这段时间，属于您和灸火的对话。安静地，感受它。`,
    closingScript: `静养就到这里。灸火已经温通了您的经脉。
接下来，我们进入灸感沟通——我来给您讲讲，灸中和灸后，您的身体可能会出现哪些反应。`,
    tips: [
      '【安全第一】检查灸鼎铁丝网是否完好',
  ...
  },
  {
    ...
    openingScript: `姐，我来给您讲一下灸中可能出现的反应和灸后的注意事项。
第一轮——灸中反应：
...
现在，进入最后一个环节——国灸疗愈心法。请您跟随我的声音，进入禅定。`,
    tips: [
  ...
  },
  {
    ...
    openingScript: `姐姐，静禅国灸真正的文化，是在一个「禅」字上。
现在，灸已经放在您身上了，我来给您做一个疗愈心法。
请您跟随我的节奏，慢慢地深呼吸——
吸气……吐气……
吸气……吐气……
