  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-50 to-pink-50 px-4">
      <div className="glass-card p-8 text-center max-w-sm">
        ...
        <h2 className="text-lg font-bold font-serif text-gray-800 mb-2">诊断模块加载异常</h2>
        <p className="text-sm text-gray-500 mb-6">请稍后重试</p>
        <button onClick={reset} className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-purple-700 to-purple-500 text-white text-sm font-bold font-serif transition hover:shadow-md">
          重新加载
        </button>
      </div>
    </div>
