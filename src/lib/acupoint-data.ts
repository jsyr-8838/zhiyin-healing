...
export const meridians: Meridian[] = [
  ...
  },
  {
    ...
    points: [
      P("cv3", "中极", "Zhōngjí", "CV3", "cv", [0, B.pubis + 0.02, 0.01], "mid"),
      P("cv4", "关元", "Guānyuán", "CV4", "cv", [0, B.danTian - 0.04, 0.01], "mid"),
      P("cv6", "气海", "Qìhǎi", "CV6", "cv", [0, B.danTian + 0.02, 0.01], "mid"),
      P("cv12", "中脘", "Zhōngwǎn", "CV12", "cv", [0, B.xiphoid - 0.02, 0.01], "mid"),
      P("cv17", "膻中", "Dànzhōng", "CV17", "cv", [0, B.nipple + 0.02, 0.01], "mid"),
      P("cv22", "天突", "Tiāntū", "CV22", "cv", [0, B.neck - 0.04, 0.01], "mid"),
      P("cv24", "承浆", "Chéngjiāng", "CV24", "cv", [0, B.mouth - 0.04, 0.01], "mid"),
    ],
  },
  {
    id: "gv",
