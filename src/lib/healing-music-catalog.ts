...
const CATALOG: HealingTrack[] = [
  ...
  },
  {
    ...
    title: '古琴·浴火重生',
    subtitle: '疏肝解郁·豁然开朗',
    src: '/audio/guqin/after-the-fire.mp3',
    instrument: 'guqin',
    element: 'jiao',
    color: '#27AE60',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '古筝·山泉清音',
    subtitle: '疏肝解郁·清流石上',
    src: '/audio/guzheng/mountain-spring.mp3',
    instrument: 'guzheng',
    element: 'jiao',
    color: '#27AE60',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '古筝·山泉短曲',
    subtitle: '疏肝解郁·短版精听',
    src: '/audio/guzheng/mountain-spring-short.mp3',
    instrument: 'guzheng',
    element: 'jiao',
    color: '#27AE60',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '古琴·新春新气',
    subtitle: '疏肝解郁·万物生发',
    src: '/audio/guqin/lunar-new-year.mp3',
    instrument: 'guqin',
    element: 'jiao',
    color: '#27AE60',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '箫·竹林清风',
    subtitle: '疏肝解郁·竹影婆娑',
    src: '/audio/xiao/zen-bamboo-flow.mp3',
    instrument: 'xiao',
    element: 'jiao',
    color: '#27AE60',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '箫·竹林低语',
    subtitle: '疏肝解郁·风穿竹林',
    src: '/audio/xiao/whispers-bamboo-forest.mp3',
    instrument: 'xiao',
    element: 'jiao',
    color: '#27AE60',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '五行·春生',
    subtitle: '疏肝解郁·万物萌发',
    src: '/audio/wuxing/spring-16211.mp3',
    instrument: 'world',
    element: 'jiao',
    color: '#27AE60',
  ...
  },
  {
    ...
    title: '古筝·欢爱',
    subtitle: '养心安神·情意绵绵',
    src: '/audio/guzheng/happy-love.mp3',
    instrument: 'guzheng',
    element: 'zhi',
    color: '#E74C3C',
    credit: 'Pixabay CC0',
  ...
  },
  {
    ...
    title: '编钟·新春华章',
    subtitle: '养心安神·喜气洋洋',
    src: '/audio/bianzhong/lunar-new-year.mp3',
  ...
  },
  {
    ...
    title: '古琴·新春短曲',
    subtitle: '养心安神·喜乐欢畅',
    src: '/audio/guqin/new-year-short.mp3',
    instrument: 'guqin',
    element: 'zhi',
    color: '#E74C3C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '箫·竹林幽韵',
    subtitle: '养心安神·和煦温柔',
    src: '/audio/xiao/whispering-bamboo-melody.mp3',
    instrument: 'xiao',
    element: 'zhi',
    color: '#E74C3C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '五行·夏长',
    subtitle: '养心安神·热情绽放',
    src: '/audio/wuxing/summer-vibes-158665.mp3',
    instrument: 'world',
    element: 'zhi',
    color: '#E74C3C',
    credit: 'Pixabay CC0 (5xing-music)',
  ...
  },
  {
    ...
    title: '编钟·金声玉振',
    subtitle: '健脾和胃·中正平和',
    src: '/audio/bianzhong/new-year.mp3',
    instrument: 'bianzhong',
    element: 'gong',
    color: '#F39C12',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '编钟·庆典短章',
    subtitle: '健脾和胃·铿锵明快',
    src: '/audio/bianzhong/new-year-short.mp3',
    instrument: 'bianzhong',
    element: 'gong',
    color: '#F39C12',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '冥想·静坐归中',
    subtitle: '健脾和胃·守中致和',
    src: '/audio/ambient/water/meditation-ambient.mp3',
    instrument: 'mix',
    element: 'gong',
    color: '#F39C12',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '冥想·深度归藏',
    subtitle: '健脾和胃·土德载物',
    src: '/audio/ambient/water/deep-meditation.mp3',
    instrument: 'mix',
    element: 'gong',
    color: '#F39C12',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '合奏·月下花影',
    subtitle: '健脾和胃·温厚和谐',
    src: '/audio/ambient/water/moonlit-blossoms.mp3',
    instrument: 'mix',
    element: 'gong',
    color: '#F39C12',
    credit: 'Pixabay CC0',
  ...
  },
  {
    ...
    title: '箫·桥上清箫',
    subtitle: '清肺润燥·悠远空灵',
    src: '/audio/xiao/bridge-of-avignon.mp3',
    instrument: 'xiao',
    element: 'shang',
    color: '#3498DB',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '二胡·丝柔如水',
    subtitle: '清肺润燥·柔美绵长',
    src: '/audio/erhu/smooth-as-silk.mp3',
    instrument: 'erhu',
    element: 'shang',
    color: '#3498DB',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '二胡·竹林幽弦',
    subtitle: '清肺润燥·幽深静谧',
    src: '/audio/erhu/bamboo-grove.mp3',
    instrument: 'erhu',
    element: 'shang',
    color: '#3498DB',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '箫·天际长箫',
    subtitle: '清肺润燥·寥廓无涯',
    src: '/audio/xiao/infinite-sky.mp3',
    instrument: 'xiao',
    element: 'shang',
    color: '#3498DB',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '编钟·禅寺晨钟',
    subtitle: '清肺润燥·金声远播',
    src: '/audio/bianzhong/zen-bamboo-temple.mp3',
    instrument: 'bianzhong',
    element: 'shang',
    color: '#3498DB',
    credit: 'Pixabay CC0',
  ...
  },
  {
    ...
    title: '箫·行远不迷',
    subtitle: '固肾益精·深邃沉静',
    src: '/audio/xiao/never-be-lost.mp3',
    instrument: 'xiao',
    element: 'yu',
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '二胡·溪流奔城',
    subtitle: '固肾益精·变化流动',
    src: '/audio/erhu/stream-to-city.mp3',
    instrument: 'erhu',
    element: 'yu',
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '冥想·静心观水',
    subtitle: '固肾益精·水善下流',
    src: '/audio/ambient/water/meditation-music.mp3',
    instrument: 'mix',
    element: 'yu',
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '箫·幽谷空灵',
    subtitle: '固肾益精·万籁俱寂',
    src: '/audio/xiao/silent-valley.mp3',
    instrument: 'xiao',
    element: 'yu',
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '箫·治愈呼吸',
    subtitle: '固肾益精·深长呼吸',
    src: '/audio/xiao/healing-breath.mp3',
    instrument: 'xiao',
    element: 'yu',
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '二胡·月升之夜',
    subtitle: '固肾益精·深沉婉转',
    src: '/audio/erhu/full-moon-rises.mp3',
    instrument: 'erhu',
    element: 'yu',
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  ...
  // ─── 角音 · 木行 · 扩展 (8曲) ────────────────────────────
  {
    ...
    title: '古琴·高山流水',
    subtitle: '疏肝解郁·知音难觅',
    src: '/audio/healing/gaoshan-liushui.mp3',
    instrument: 'guqin',
    element: 'jiao',
    color: '#27AE60',
    duration: 420,
  ...
  },
  {
    ...
    title: '古琴·梅花三弄',
    subtitle: '疏肝解郁·傲骨凌霜',
    src: '/audio/healing/meihua-sannong.mp3',
    instrument: 'guqin',
    element: 'jiao',
    color: '#27AE60',
    duration: 360,
  ...
  },
  {
    ...
    title: '琵琶·春江花月夜',
    subtitle: '疏肝解郁·月照春江',
    src: '/audio/healing/chunjiang-huayueye.mp3',
    instrument: 'pipa',
    element: 'jiao',
    color: '#27AE60',
    duration: 390,
  ...
  },
  {
    ...
    title: '笛子·姑苏行',
    subtitle: '疏肝解郁·江南春晓',
    src: '/audio/healing/gusu-xing.mp3',
    instrument: 'dizi',
    element: 'jiao',
    color: '#27AE60',
    duration: 300,
  ...
  },
  {
    ...
    title: '古琴·幽兰逢春',
    subtitle: '疏肝解郁·兰生幽谷',
    src: '/audio/healing/youlan-fengchun.mp3',
    instrument: 'guqin',
    element: 'jiao',
    color: '#27AE60',
    duration: 330,
  ...
  },
  {
    ...
    title: '古琴·平沙落雁',
    subtitle: '疏肝解郁·天际归鸿',
    src: '/audio/healing/pingsa-luoyan.mp3',
    instrument: 'guqin',
    element: 'jiao',
    color: '#27AE60',
    duration: 360,
  ...
  },
  {
    ...
    subtitle: '疏肝解郁·绿意盎然',
    src: '/audio/healing/green-tapestry.mp3',
    instrument: 'world',
    element: 'jiao',
    color: '#27AE60',
    duration: 300,
  ...
  },
  {
    ...
    title: '喜多郎·Silk Road',
    subtitle: '疏肝解郁·丝路苍茫',
    src: '/audio/healing/silk-road.mp3',
    instrument: 'world',
    element: 'jiao',
    color: '#27AE60',
    duration: 330,
  ...
  // ─── 徵音 · 火行 · 扩展 (8曲) ────────────────────────────
  {
    ...
    title: '琵琶·十面埋伏',
    subtitle: '养心安神·金戈铁马',
    src: '/audio/healing/shimian-maifu.mp3',
    instrument: 'pipa',
    element: 'zhi',
    color: '#E74C3C',
    duration: 360,
  ...
  },
  {
    ...
    title: '唢呐·金蛇狂舞',
    subtitle: '养心安神·欢腾热烈',
    src: '/audio/healing/jinshe-kuangwu.mp3',
    instrument: 'suona',
    element: 'zhi',
    color: '#E74C3C',
    duration: 240,
  ...
  },
  {
    ...
    title: '唢呐·百鸟朝凤',
    subtitle: '养心安神·百鸟争鸣',
    src: '/audio/healing/bainiao-chaofeng.mp3',
    instrument: 'suona',
    element: 'zhi',
    color: '#E74C3C',
    duration: 390,
  ...
  },
  {
    ...
    title: '琵琶·彩云追月',
    subtitle: '养心安神·彩云逐月',
    src: '/audio/healing/caiyun-zhuiyue.mp3',
    instrument: 'pipa',
    element: 'zhi',
    color: '#E74C3C',
    duration: 270,
  ...
  },
  {
    ...
    title: '古琴·出水莲',
    subtitle: '养心安神·莲出淤泥',
    src: '/audio/healing/chushui-lian.mp3',
    instrument: 'guqin',
    element: 'zhi',
    color: '#E74C3C',
    duration: 300,
  ...
  },
  {
    ...
    subtitle: '养心安神·梵音日光',
    src: '/audio/healing/sundance.mp3',
    instrument: 'world',
    element: 'zhi',
    color: '#E74C3C',
    duration: 300,
  ...
  },
  {
    ...
    subtitle: '养心安神·吠陀圣咒',
    src: '/audio/healing/gayatri-mantra.mp3',
    instrument: 'world',
    element: 'zhi',
    color: '#E74C3C',
    duration: 360,
  ...
  },
  {
    ...
    subtitle: '养心安神·千日之光',
    src: '/audio/healing/a-thousand-suns.mp3',
    instrument: 'world',
    element: 'zhi',
    color: '#E74C3C',
    duration: 330,
  ...
  // ─── 宫音 · 土行 · 扩展 (8曲) ────────────────────────────
  {
    ...
    title: '二胡·二泉映月',
    subtitle: '健脾和胃·月映双泉',
    src: '/audio/healing/erquan-yingyue.mp3',
    instrument: 'erhu',
    element: 'gong',
    color: '#F39C12',
    duration: 390,
  ...
  },
  {
    ...
    title: '二胡·汉宫秋月',
    subtitle: '健脾和胃·秋月汉宫',
    src: '/audio/healing/hangong-qiuyue.mp3',
    instrument: 'erhu',
    element: 'gong',
    color: '#F39C12',
    duration: 360,
  ...
  },
  {
    ...
    title: '琵琶·夕阳箫鼓',
    subtitle: '健脾和胃·夕阳箫声',
    src: '/audio/healing/xiyang-xiaogu.mp3',
    instrument: 'pipa',
    element: 'gong',
    color: '#F39C12',
    duration: 330,
  ...
  },
  {
    ...
    title: '古琴·阳关三叠',
    subtitle: '健脾和胃·西出阳关',
    src: '/audio/healing/yangguan-sandie.mp3',
    instrument: 'guqin',
    element: 'gong',
    color: '#F39C12',
    duration: 360,
  ...
  },
  {
    ...
    title: '古琴·满江红',
    subtitle: '健脾和胃·壮怀激烈',
    src: '/audio/healing/manjiang-hong.mp3',
    instrument: 'guqin',
    element: 'gong',
    color: '#F39C12',
    duration: 300,
  ...
  },
  {
    ...
    subtitle: '健脾和胃·大地蔚蓝',
    src: '/audio/healing/earth-blue.mp3',
    instrument: 'world',
    element: 'gong',
    color: '#F39C12',
    duration: 330,
  ...
  },
  {
    ...
    subtitle: '健脾和胃·神秘召唤',
    src: '/audio/healing/call-of-the-mystic.mp3',
    instrument: 'world',
    element: 'gong',
    color: '#F39C12',
    duration: 360,
  ...
  },
  {
    ...
    subtitle: '健脾和胃·敬拜湿婆',
    src: '/audio/healing/om-namah-shivaya.mp3',
    instrument: 'world',
    element: 'gong',
    color: '#F39C12',
    duration: 300,
  ...
  // ─── 商音 · 金行 · 扩展 (8曲) ────────────────────────────
  {
    ...
    title: '古琴·广陵散',
    subtitle: '清肺润燥·广陵绝响',
    src: '/audio/healing/guangling-san.mp3',
    instrument: 'guqin',
    element: 'shang',
    color: '#3498DB',
    duration: 420,
  ...
  },
  {
    ...
    title: '古琴·潇湘水云',
    subtitle: '清肺润燥·云水潇湘',
    src: '/audio/healing/xiaoxiang-shuiyun.mp3',
    instrument: 'guqin',
    element: 'shang',
    color: '#3498DB',
    duration: 390,
  ...
  },
  {
    ...
    title: '古筝·渔舟唱晚',
    subtitle: '清肺润燥·渔歌晚唱',
    src: '/audio/healing/yuzhou-changwan.mp3',
    instrument: 'guzheng',
    element: 'shang',
    color: '#3498DB',
    duration: 300,
  ...
  },
  {
    ...
    title: '古筝·寒鸦戏水',
    subtitle: '清肺润燥·寒鸦戏水',
    src: '/audio/healing/hanya-xishui.mp3',
    instrument: 'guzheng',
    element: 'shang',
    color: '#3498DB',
    duration: 270,
  ...
  },
  {
    ...
    subtitle: '清肺润燥·银月清辉',
    src: '/audio/healing/silver-moon.mp3',
    instrument: 'world',
    element: 'shang',
    color: '#3498DB',
    duration: 330,
  ...
  },
  {
    ...
    subtitle: '清肺润燥·梦想商队',
    src: '/audio/healing/caravan-of-dreams.mp3',
    instrument: 'world',
    element: 'shang',
    color: '#3498DB',
    duration: 300,
  ...
  },
  {
    ...
    subtitle: '清肺润燥·水印涟漪',
    src: '/audio/healing/watermark.mp3',
    instrument: 'world',
    element: 'shang',
    color: '#3498DB',
    duration: 270,
  ...
  // ─── 羽音 · 水行 · 扩展 (8曲) ────────────────────────────
  {
    ...
    title: '古琴·阳春白雪',
    subtitle: '固肾益精·阳春白雪',
    src: '/audio/healing/yangchun-baixue.mp3',
    instrument: 'guqin',
    element: 'yu',
    color: '#1ABC9C',
    duration: 360,
  ...
  },
  {
    ...
    title: '古琴·渔樵问答',
    subtitle: '固肾益精·渔樵问答',
    src: '/audio/healing/yuqiao-wenda.mp3',
    instrument: 'guqin',
    element: 'yu',
    color: '#1ABC9C',
    duration: 390,
  ...
  },
  {
    ...
    title: '古琴·良宵引',
    subtitle: '固肾益精·良宵月引',
    src: '/audio/healing/liangxiao-yin.mp3',
    instrument: 'guqin',
    element: 'yu',
    color: '#1ABC9C',
    duration: 240,
  ...
  },
  {
    ...
    title: '古琴·关山月',
    subtitle: '固肾益精·关山冷月',
    src: '/audio/healing/guanshan-yue.mp3',
    instrument: 'guqin',
    element: 'yu',
    color: '#1ABC9C',
    duration: 270,
  ...
  },
  {
    ...
    title: '古琴·忆故人',
    subtitle: '固肾益精·忆念故人',
    src: '/audio/healing/yi-guren.mp3',
    instrument: 'guqin',
    element: 'yu',
    color: '#1ABC9C',
    duration: 330,
  ...
  },
  {
    ...
    subtitle: '固肾益精·唯有时光',
    src: '/audio/healing/only-time.mp3',
    instrument: 'world',
    element: 'yu',
    color: '#1ABC9C',
    duration: 240,
  ...
  },
  {
    ...
    src: '/audio/healing/orinoco-flow.mp3',
    instrument: 'world',
    element: 'yu',
    color: '#1ABC9C',
    duration: 270,
  ...
  },
  {
    ...
    subtitle: '固肾益精·生命之水',
    src: '/audio/healing/water-of-life.mp3',
    instrument: 'world',
    element: 'yu',
    color: '#1ABC9C',
    duration: 300,
...
const BOWL_CATALOG: BowlTrack[] = [
  // ─── 水晶钵 ───
  {
    ...
    title: '水晶钵·清音',
    subtitle: '清透纯净·高频渗透',
    src: '/audio/singing-bowl/crystal-singing-bowl.mp3',
    bowlType: 'crystal',
    freq: 528,
    color: '#E74C3C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '水晶钵·石英共鸣',
    subtitle: '石英共振·身心通透',
    src: '/audio/singing-bowl/crystal-quartz-resonance.mp3',
    bowlType: 'crystal',
    freq: 741,
    color: '#3498DB',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '水晶钵·空明入定',
    subtitle: '晶莹澄澈·入静冥想',
    src: '/audio/singing-bowl/crystal-clear-meditation.mp3',
    bowlType: 'crystal',
    freq: 432,
    color: '#4B0082',
    credit: 'Pixabay CC0',
  ...
  // ─── 藏钵 ───
  {
    ...
    title: '藏钵·灵性之旅',
    subtitle: '深沉悠远·灵性传统',
    src: '/audio/singing-bowl/tibetan-journey.mp3',
    bowlType: 'tibetan',
    freq: 396,
    color: '#2C3E50',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '藏钵·深层疗愈',
    subtitle: '深邃共振·释放恐惧',
    src: '/audio/singing-bowl/tibetan-deep-healing.mp3',
    bowlType: 'tibetan',
    freq: 174,
    color: '#1a1a2e',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '藏钵·宁静安住',
    subtitle: '禅定安宁·回归当下',
    src: '/audio/singing-bowl/tibetan-ambient-peace.mp3',
    bowlType: 'tibetan',
    freq: 256,
    color: '#8B2500',
    credit: 'Pixabay CC0',
  ...
  // ─── 铜钵/混合 ───
  {
    ...
    title: '颂钵·瑜伽冥想',
    subtitle: '浑厚共振·经典之声',
    src: '/audio/singing-bowl/yoga-meditation.mp3',
    bowlType: 'brass',
    freq: 639,
    color: '#F39C12',
    credit: 'Pixabay CC0',
  ...
  // ─── 新增钵体 (第二轮下载) ───
  {
    ...
    title: '颂钵·疗愈波浪',
    subtitle: '涟漪扩散·眉心轮共振',
    src: '/audio/singing-bowl/healing-waves.mp3',
    bowlType: 'crystal',
    freq: 432,
    color: '#4B0082',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '颂钵·疗愈海岸',
    subtitle: '潮汐涌退·和谐共振',
    src: '/audio/singing-bowl/healing-shores.mp3',
    bowlType: 'mix',
    freq: 639,
    color: '#F39C12',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '藏钵·禅意悠远',
    subtitle: '精神回归·空灵通透',
    src: '/audio/singing-bowl/zen-moods.mp3',
    bowlType: 'tibetan',
    freq: 852,
    color: '#1ABC9C',
    credit: 'Pixabay CC0',
  },
  {
    ...
    title: '藏钵·呼吸冥想',
    subtitle: '深长呼吸·舒缓痛症',
    src: '/audio/singing-bowl/breathe-with-me.mp3',
    bowlType: 'tibetan',
    freq: 174,
    color: '#1a1a2e',
    credit: 'Pixabay CC0',
