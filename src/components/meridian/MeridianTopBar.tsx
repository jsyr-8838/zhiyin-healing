  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-2 pointer-events-none">
      <div className="flex items-center gap-2">
        <a
          href="/dashboard"
          className="md:hidden pointer-events-auto w-10 h-10 rounded-full bg-black/80 border border-white/10 flex items-center justify-center text-white text-lg hover:bg-black/90 transition-colors"
        >
          ←
        </a>
        <button
          onClick={onToggleSidebar}
          className="md:hidden pointer-events-auto w-10 h-10 rounded-full bg-black/80 border border-white/10 flex items-center justify-center text-white text-lg"
        >
          ☰
        </button>
      </div>
      ...
      <div
        className="hidden md:flex pointer-events-auto items-center gap-3 bg-black/80 border border-white/10 rounded-2xl px-4 py-2 cursor-pointer hover:border-white/20 transition-colors"
      ...
      <div className="pointer-events-auto flex items-center gap-3 bg-black/80 border border-white/10 rounded-2xl px-4 py-2">
